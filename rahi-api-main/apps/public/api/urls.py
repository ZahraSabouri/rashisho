...
router.register("notifications", notification.NotificationViewSet, basename="notifications")
router.register("announcements", notification.AnnouncementViewSet, basename="announcements")
